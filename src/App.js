...
class App extends Component {
  ...
  render() {
    return (
      <Layout
        style={{
          backgroundImage: 'url(' + require('@/assets/images/bg.gif') + ')'
        }}
      >
        <Row>
              ...
              >
                ...
                {this.state.userInfo ? (
                  <span className="account">
                    <Avatar key="avatar" icon="user" />
                    {this.state.userInfo.nickname ||
                      this.state.userInfo.account}
                  </span>
                ) : (
                  <span
                    className="account nologin"
          ...
          >
            <Content className="xsPadding">
              ...
              <div className="ant-content">
                <h1>
                  Hello{' '}
                  {this.props.userInfo.nickname || this.props.userInfo.account}{' '}
                </h1>
                <Fragment>
                  <Switch>
        ...
        <LoginDrawer
          ...
          onClose={this.hideLoginDrawer}
          onLogin={this.onLogin}
        />
        <Footer style={{ textAlign: 'center' }}>
          <p>
            Copyright © 2019 apony.xyz(小马哥) All Rights Reserved
            粤ICP备52512138号
          </p>
          <p>
            骄傲的使用了新一代Web开发框架
            <a href="https://koa.bootcss.com/" target="_blank">
              koa
            </a>
          </p>
        </Footer>
